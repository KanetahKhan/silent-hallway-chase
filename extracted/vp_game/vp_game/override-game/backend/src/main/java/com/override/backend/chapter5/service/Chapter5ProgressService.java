package com.override.backend.chapter5.service;
...
@Service
public class Chapter5ProgressService {

    private static final int CHAPTER_NUMBER = 5;

    private final ChapterProgressRepository progressRepo;
    private final PlayerService playerService;

    public Chapter5ProgressService(ChapterProgressRepository progressRepo, PlayerService playerService) {
