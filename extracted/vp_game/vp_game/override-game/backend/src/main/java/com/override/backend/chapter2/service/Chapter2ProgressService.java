package com.override.backend.chapter2.service;
...
@Service
public class Chapter2ProgressService {

    private static final int CHAPTER_NUMBER = 2;

    private final ChapterProgressRepository progressRepo;
    private final PlayerService playerService;

    public Chapter2ProgressService(ChapterProgressRepository progressRepo, PlayerService playerService) {
