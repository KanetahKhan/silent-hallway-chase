package com.override.backend.chapter3.service;
...
@Service
public class Chapter3ProgressService {

    private static final int CHAPTER_NUMBER = 3;

    private final ChapterProgressRepository progressRepo;
    private final PlayerService playerService;

    public Chapter3ProgressService(ChapterProgressRepository progressRepo, PlayerService playerService) {
