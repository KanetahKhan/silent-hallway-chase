package com.override.backend.chapter4.service;
...
@Service
public class Chapter4ProgressService {

    private static final int CHAPTER_NUMBER = 4;

    private final ChapterProgressRepository progressRepo;
    private final PlayerService playerService;

    public Chapter4ProgressService(ChapterProgressRepository progressRepo, PlayerService playerService) {
